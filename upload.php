...
if($_POST)
{
	...
	$data['technicaldescription'] = isset($_POST['technicaldescription']) ? $_POST['technicaldescription']:'';
	...
	$data['design-int'] = isset($_POST['design-int']) ? 'yes': 'no';
	$data['hybrid-mod'] = isset($_POST['hybrid-mod']) ? 'yes': 'no';
	$data['as-built'] = isset($_POST['as-built']) ? 'yes': 'no';
	$data['scan-nurbs'] = isset($_POST['scan-nurbs']) ? 'yes': 'no';
	$data['cad-neutral'] = isset($_POST['cad-neutral']) ? 'yes': 'no';
	$data['live-transfer'] = isset($_POST['live-transfer']) ? 'yes': 'no';
	$data['other'] = isset($_POST['other']) ? 'yes': 'no';
	$data['upload_link'] = '';
