...
function render_email($email, $data) {
    ob_start();
    include "figurebookdemo_email.phtml";
...
if($_POST)
{
	...
	$data['date'] = isset($_POST['web_date']) ? $_POST['web_date']:'';
	$body = render_email('email', $data);

	$subject = "You have a message from your client for Book a demo";
	...
	$mail->From = $from;
	$mail->FromName = "Book a demo form from 3d printer figure";
