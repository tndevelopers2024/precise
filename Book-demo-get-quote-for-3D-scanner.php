<?php
$dev_step = isset($_GET['step']) ? (int)$_GET['step'] : 1;
if ($dev_step < 1 || $dev_step > 3) {
    $dev_step = 1;
}
?>
<!DOCTYPE html>
        ...
        <div class="demo-split-container">
          ...
          <div class="row align-items-center mb-4 d-none d-lg-flex position-relative z-3 pt-4 px-3 px-lg-5">
            ...
            <div class="col-lg-6 text-center" style="z-index: 100;">
              ...
              <p class="demo-subtitle mb-0">Choose the way that's convenient for you.<br>
                <span class="text-orange">Onsite</span> at your facility or <span class="text-orange">Online</span> with
                our experts.
              </p>
            </div>
          ...
          <div class="demo-bottom-row position-absolute w-100 demo-bottom-row-pos">
            <div class="row align-items-end mx-0 px-lg-4">
              ...
              <!-- Center Stats -->
              <div
                class="col-lg-4 mb-3 mb-lg-0 d-flex justify-content-center flex-wrap gap-3 gap-xl-4 hero-bottom-stats-col">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-12">
            ...
            <div class="text-center mb-5">
              ...
              <div
                class="progress-header d-flex flex-wrap justify-content-center align-items-center progress-header-gap">
            ...
            <!-- Form Card (Step 1) -->
            <div class="demo-form-card" id="step-1"
              style="display: <?php echo ($dev_step == 1) ? 'block' : 'none'; ?>;">
              ...
              <form id="bookDemoFormStep1" onsubmit="event.preventDefault(); goToStep2();">
                <div class="row g-4">
                  ...
                  <div class="col-md-6 py-2">
                    ...
                    <input type="text" class="form-control demo-input" id="firstName" placeholder="Enter Full Name"
                      required>
                  </div>
                  <div class="col-md-6 py-2">
                  ...
                  <div class="col-md-6 py-2">
                    ...
                    <input type="text" class="form-control demo-input" id="companyName" placeholder="Enter Company Name"
                      required>
                  </div>
                  <div class="col-md-6 py-2">
                  ...
                  <div class="col-md-6 py-2">
                    ...
                    <input type="email" class="form-control demo-input" id="businessEmail"
                  ...
                  <div class="col-md-6 col-12 py-2">
                    ...
                    <div class="mobile-phone-container">
                      <div class="country-select-wrapper">
                        ...
                        <select id="mobileCountrySelect" class="country-code-select" onchange="updateCountryCode(this)"
                          required>
                          ...
                          <option value="+290" data-flag="sh">+290 (Saint Helena, Ascension and Tristan Da Cunha)
                          </option>
                          ...
                          <option value="+500" data-flag="gs">+500 (South Georgia and the South Sandwich Islands)
                          </option>
                      ...
                      <input type="tel" class="mobile-phone-input demo-input flex-grow-1" id="mobileNumber"
                ...
                <!-- Submit Row -->
                <div class="mt-4">
                  <button type="submit" class="btn-continue w-100 d-flex justify-content-center align-items-center"
                    id="btnContinueStep1" disabled>
            ...
            <!-- Form Card (Step 2) -->
            <div class="demo-form-card step-2-card" id="step-2"
              style="display: <?php echo ($dev_step == 2) ? 'block' : 'none'; ?>;">
              <!-- Badge -->
              ...
              <div class="d-flex p-1 mb-4 category-tabs">
                ...
                <div class="flex-fill text-center py-2 tab-item" data-target="engineering-services">Engineering & 3D
                  Services</div>
                <div class="flex-fill text-center py-2 tab-item" data-target="business-opportunities">Business
                  Opportunities</div>
              </div>
              ...
              <form id="bookDemoFormStep2" onsubmit="event.preventDefault(); goToStep3();">
                ...
                <div id="buy-products" class="tab-content-block">
                  <label class="product-option mb-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">Entry-level, Professional, and metrology grade 3D Scanners
                      </p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="3D Scanners">
                    </div>
                  </label>
                  ...
                  <label class="product-option mb-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">3D Inspection, 3D Reverse engineering, scan-to-CAD, and
                        flat pattern creation software.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="3D Scanning Software">
                    </div>
                  </label>
                  ...
                  <label class="product-option mb-4 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">Industrial and professional 3D printing solutions for
                        prototyping and manufacturing.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="3D Printers">
                ...
                <div id="engineering-services" class="tab-content-block" style="display: none;">
                  <label class="product-option mb-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">On-site or off-site industrial 3D scanning for parts,
                        vehicles, plants, and facilities.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="3D Scanning Services">
                    </div>
                  </label>

                  <label class="product-option mb-3 d-flex align-items-center">
                    <div class="icon-box me-3">
                      <img src="assets/images/book-a-live-demo/engineering-2.svg" alt="3D Inspection Services"
                        width="30">
                    </div>
                    <div class="flex-grow-1 px-2">
                      <h5 class="mb-1 fw-bold demo-sec-title">3D Inspection Services</h5>
                      <p class="mb-0 text-muted demo-sm-text">Dimensional inspection, GD&T validation, and deviation
                        analysis reports.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="3D Inspection Services">
                    </div>
                  </label>

                  <label class="product-option mb-3 d-flex align-items-center">
                    <div class="icon-box me-3">
                      <img src="assets/images/book-a-live-demo/engineering-3.svg" alt="Reverse Engineering Services"
                        width="30">
                    </div>
                    <div class="flex-grow-1 px-2">
                      <h5 class="mb-1 fw-bold demo-sec-title">Reverse Engineering Services</h5>
                      <p class="mb-0 text-muted demo-sm-text">Convert physical parts into editable CAD models for
                        manufacturing and redesign.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="Reverse Engineering Services">
                    </div>
                  </label>

                  <label class="product-option mb-3 d-flex align-items-center">
                    <div class="icon-box me-3">
                      <img src="assets/images/book-a-live-demo/engineering-4.svg" alt="Automotive Benchmarking Services"
                        width="30">
                    </div>
                    <div class="flex-grow-1 px-2">
                      <h5 class="mb-1 fw-bold demo-sec-title">Automotive Benchmarking Services</h5>
                      <p class="mb-0 text-muted demo-sm-text">Vehicle scanning, digital benchmarking, teardown studies,
                        and competitive analysis.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="Automotive Benchmarking Services">
                    </div>
                  </label>
                ...
                <div id="business-opportunities" class="tab-content-block" style="display: none;">
                  <label class="product-option mb-3 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">Become a reseller, distributor, training partner, or
                        service partner.</p>
                    </div>
                    <div class="ms-3">
                      <input type="checkbox" class="custom-checkbox step2-checkbox" name="interest[]"
                        value="Channel Partnership">
                    </div>
                  </label>
                  ...
                  <label class="product-option mb-4 d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 px-2">
                      ...
                      <p class="mb-0 text-muted demo-sm-text">Projects, collaborations, research, training, rentals, or
                    ...
                    <div class="col-md-4">
                      <label class="demo-type-option d-flex align-items-center p-3 h-100">
                        <div class="ms-1 me-3 px-3">
                          <input class="form-check-input custom-radio demo-type-radio" type="radio" name="demoType"
                            value="Online Demo">
                        </div>
                        <div>
                ...
                <div class="d-flex justify-content-between mt-5">
                  <button type="button" class="btn-back d-flex align-items-center justify-content-center"
                    onclick="goToStep1()">
                    <i class="fa-solid fa-arrow-left"></i> <span class="px-2">Back</span>
                  </button>
                  <button type="submit" id="btnContinueStep2"
            ...
            <!-- Form Card (Step 3) -->
            <div class="demo-form-card step-3-card" id="step-3"
              style="display: <?php echo ($dev_step == 3) ? 'block' : 'none'; ?>;">
              <!-- Badge -->
              <div class="d-inline-block px-3 py-1 mb-3" class="step-badge">
                Step 3
              </div>
              ...
              <form id="bookDemoFormStep3" onsubmit="event.preventDefault(); submitForm();">
                  ...
                  <div class="col-lg-6 pt-5">
                    ...
                    <div class="row g-3">
                      <div class="col-6 py-2">
                        <label
                          class="time-slot-option d-flex align-items-center justify-content-center p-2 text-center h-100">
                          <input class="form-check-input d-none time-slot-radio" type="radio" name="demoTime"
                            value="09:00 AM - 10:00 AM" required>
                ...
                <div class="d-flex justify-content-between mt-5">
                  ...
                  <button type="submit" id="btnConfirmSlot"
                    class="btn-continue d-flex align-items-center justify-content-center btn-orange-solid">
