...
$industry = isset($input['industry']) ? $input['industry'] : 'No Industry';
...
<body>
<div class="container">
    <h2>New Scanning Solution Request - Step 1 Completed</h2>
    <p>A user has completed Step 1 of the scanning solution form on Precise3DM. Here are their contact details:</p>
    ...
    <table>
        ...
        <tr><th>Industry</th><td>' . htmlspecialchars($industry) . '</td></tr>
    </table>
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = "Step 1 Completed: Scanning Solution Request from " . $name;
    $mail->Body = $htmlBody;
