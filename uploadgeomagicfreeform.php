...
function render_email($email, $data) {
    ob_start();
    include "email_template_Geomagixfreeform.phtml";
...
if($_POST)
{
	...
	$mail->From = $from;
	$mail->FromName = "Customer Submitted a form from Geomagic Freeform";
...
try {
 ...
 header("Location: https://www.precise3dm.com/geomagic-freeform-3d-modelling-design-software.php#geoform");
