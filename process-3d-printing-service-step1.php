...
<body>
<div class="container">
    <h2>New 3D Printing Request - Step 1 Completed</h2>
    <p>A user has completed Step 1 of the 3D printing service request on Precise3DM. Here are their contact details:</p>
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = "Step 1 Completed: 3D Printing Request from " . $name;
    $mail->Body = $htmlBody;
