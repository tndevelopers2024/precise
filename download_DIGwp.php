...
function render_email($email, $data) {
    ob_start();
    include "email_temp_DIGwp.phtml";
...
if($_POST)
{
	...
	$mail->From = $from;
	$mail->FromName = "Customer Submitted a form from Geomagic Wrap";
...
try {
 ...
 header("Location: https://www.precise3dm.com/geomagic-wrap-3d-scanning-software.php#geoform");
