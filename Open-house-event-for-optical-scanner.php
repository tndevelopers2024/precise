...
<head>
    ...
    <title>open house event for optical scanner</title>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem", 
        "position": 2, 
        "name": "Open House Event for Optical Scanner",
        "item": "https://www.precise3dm.com/Open-house-event-for-optical-scanner.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/Open-house-event-for-optical-scanner.php"
      },
      "headline": "open house event for optical scanner",
      "description": "3D Scanning and 3D Printing open house event",
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="events_details3_banner" class="pt-4">
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 aboutus-herohead pl-0">
                    <h1 class="text-white" id="reg click">Open House Event for Optical Scanner</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 eve-details-cont">
                    <button onclick="window.location.href='https://docs.google.com/forms/u/0/d/e/1FAIpQLSeW68El23GV9mvHrY3JNkp3cmzHMi5BEJ17ZK7oIbE8ynZDvQ/formResponse'" target="_blank" >REGISTER NOW</button>
                    <h5>Join us on Tuesday 5 th, January 2022, (9 am to 6 pm)</h5>
                    <div class="row eve-details-2">
                        <div class="col-md-8">
                            <h4>What is this event about?</h4>
                             <p>With the leading global providers of 3d scanners and inspection software, Precise3DM will present optical and handheld metrology workflow. Attendees will be taken through both 3d scanning techniques and their strengths and advantages. Post 3d scanning we will also demo the automated 3D inspection of mass volume parts using Digital Inspection Software Geomagic Control X.</p>
                        </div>
                ...
                <div class="col-md-12 eve-details-3">
                    ...
                    <ul>
                        ...
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Venue: Precise3DM Mumbai, Technopark Borivali west 
 </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Time morning 9 to 6 pm ( Must pre-book the slots as each slot only ten members are allowed )
 </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Screws and fasteners manufacturers 
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Plastic, Rubber, and electric components manufacturers 
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Jewelry manufacturers.  
                        </li>
                    </ul>
                    <h4>What are the benefits of attending this event?</h4>
                    <ul>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Explore the most innovative way of measuring your components  
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Improve your 3D inspection Productivity.
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Interact with global specialists on your metrology needs. 
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                        Bring live parts, get them inspected on the spot. 
