...
function render_email($email, $data) {
    ob_start();
    include "email_temp_DSBcx.phtml";
...
if($_POST)
{
	...
	$mail->From = $from;
	$mail->FromName = "Customer Submitted a form from Geomagic Control X";
...
try {
 ...
 header("Location: https://www.precise3dm.com/geomagic-control-x-3d-inspection-software.php#geoform");
