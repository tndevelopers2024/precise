...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem", 
        "position": 2, 
        "name": "Online 3d Scanning Webinar 2021",
        "item": "https://www.precise3dm.com/online_3d_scanning_webinar_2021.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/online_3d_scanning_webinar_2021.php"
      },
      "headline": "Events India Scanning",
      "description": "Scanning Service chennai",
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="events_scanning_banner" class="pt-4 mt-lg-5">
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 aboutus-herohead pl-0">
                   <h1 class="text-white h3">3D Scanning for wood carving, art, and sculpture, with Einscan 3D scanner and Geomagic wrap</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 eve-details-cont">
                    <button onclick="window.location.href='https://docs.google.com/forms/d/e/1FAIpQLScuot_c5N459BQDRZbb3Ph02HLBJDqOQ5diMYZ9OUHnQP7nlQ/viewform'" target="_blank">REGISTER NOW</button>
                    <h5>Join us on Thursday 19th, August 2021 at 04:00</h5>
                    <div class="row eve-details-2">
                        <div class="col-md-8">
                            <h4>Live Demo & Webinar</h4>
                            <h4>3D Scanning for wood carving, art, and sculpture, with Einscan 3D scanner and Geomagic wrap</h4>
                             <ul class="event-ul">
                                <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                                    Live demo of wooden items and colored objects.
                                </li>
                                <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                                    Applications of 3D Scanning in woodcarving 
                                </li>
                                <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                                    Different Modes of 3D Scanning (Turntable, Colour, Handheld)
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4 eve-de-img">
                            <!--<img src="assets/images/events_images/events_webinarphoto.png" alt="" class="img-fluid">-->
                            <a href="https://www.precise3dm.com/handheld-3d-laser-scanner-india-einscan-pro-2x.php" class="img-adjust"><img src="assets/images/events_images/einscanpro-img.png" alt="" class="img-fluid"></a>
                            <a href="https://www.precise3dm.com/geomagic-wrap-3d-scanning-software.php"><img src="assets/images/events_images/wrap-img.png" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 eve-details-3">
                    ...
                    <ul>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Thursday 19th August 2021 4 pm evening.
                        </li>
                    </ul>
                    ...
                    <h4>What will you learn in this webinar?</h4>
                    <ul>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Learn the different types of Scanning modes   
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            NURBS surface creation from 3D scan
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Applications of 3D Scanning in art sculpture and wood carving industry 
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            how to make 3D mesh correction and software 
                        </li>
                    </ul>
                </div>
