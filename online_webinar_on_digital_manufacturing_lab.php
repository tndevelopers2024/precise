...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem", 
        "position": 2, 
        "name": "Online Webinar on Digital Manufacturing",
        "item": "https://www.precise3dm.com/online_webinar_on_digital_manufacturing_lab.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/online_webinar_on_digital_manufacturing_lab.php"
      },
      "headline": "Events India for manufacturing lab",
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="events_details2_banner" class="pt-4">
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 aboutus-herohead pl-0">
                    <h1 class="text-white">Online Webinar on Digital Manufacturing</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 eve-details-cont">
                    <button onclick="window.location.href='https://docs.google.com/forms/d/e/1FAIpQLSekXagAACUAHgImtWBpnNI3GhEMPgjZ1gyScMsjkw-lZDVerg/viewform'" target="_blank">REGISTER NOW</button>
                    <h5>Join us on Friday 20th, August 2021 at 04:00</h5>
